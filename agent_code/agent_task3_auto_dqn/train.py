...
def augment_field(old_game_state: dict, new_game_state: dict) -> List[Tuple[dict, dict]]:
...
def td_estimate(self, state, action):
    ...
    current_Q_indexed = current_Q[torch.arange(0, config.BATCH_SIZE, dtype=torch.long), action]
